...
contract VaultRouterModule {
    ...
    function depositIntoVaultForCaller(Vault vault, ERC20 underlying, uint256 amount) internal {
    ...
    /// @param r Must produce valid secp256k1 signature from the caller along with v and s.
    /// @param s Must produce valid secp256k1 signature from the caller along with r and v.
    function permitAndTransferFromCaller(ERC20 token, uint256 amount, uint256 deadline, uint8 v, bytes32 r, bytes32 s)
        internal
    {
